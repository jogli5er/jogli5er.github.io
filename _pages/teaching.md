...
- [TDT4186 Operating Systems](https://www.ntnu.edu/studies/courses/TDT4186/2021#tab=omEmnet) ([@NTNU](https://www.ntnu.edu/)): I was the teaching assistant and responsible for the labs and exercises. The main goal of the course is to give students an introduction to operating systems and to apply the presented concepts in a small, but fully functional, operating system. For the labs we are using XV6 as used in [6.1810 Operating System Engineering @ MIT](https://pdos.csail.mit.edu/6.828/2024/index.html).
